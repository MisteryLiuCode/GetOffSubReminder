...
#ifndef GETOFFSUBREMINDER_SWIFT_H
#define GETOFFSUBREMINDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GetOffSubReminder",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17GetOffSubReminder11AppDelegate")
...
SWIFT_CLASS("_TtC17GetOffSubReminder17LocationViewModel")
...
@interface LocationViewModel (SWIFT_EXTENSION(GetOffSubReminder)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC17GetOffSubReminder13SceneDelegate")
...
SWIFT_CLASS("_TtC17GetOffSubReminder14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified homeLocationLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified workLocationLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified DesChineseLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified destinationLabel;
- (IBAction)homeLocationBt:(UIButton * _Nonnull)sender;
- (IBAction)workLocationBt:(UIButton * _Nonnull)sender;
- (void)viewDidLoad;
